...
export function createChar(name) {
    switch (name) {
        ...
        // アルファベット・数字
        case "a": case "ａ": return new Char(name, ["a"]);
        case "b": case "ｂ": return new Char(name, ["b"]);
        case "c": case "ｃ": return new Char(name, ["c"]);
        case "d": case "ｄ": return new Char(name, ["d"]);
        case "e": case "ｅ": return new Char(name, ["e"]);
        case "f": case "ｆ": return new Char(name, ["f"]);
        case "g": case "ｇ": return new Char(name, ["g"]);
        case "h": case "ｈ": return new Char(name, ["h"]);
        case "i": case "ｉ": return new Char(name, ["i"]);
        case "j": case "ｊ": return new Char(name, ["j"]);
        case "k": case "ｋ": return new Char(name, ["k"]);
        case "l": case "ｌ": return new Char(name, ["l"]);
        case "m": case "ｍ": return new Char(name, ["m"]);
        case "n": case "ｎ": return new Char(name, ["n"]);
        case "o": case "ｏ": return new Char(name, ["o"]);
        case "p": case "ｐ": return new Char(name, ["p"]);
        case "q": case "ｑ": return new Char(name, ["q"]);
        case "r": case "ｒ": return new Char(name, ["r"]);
        case "s": case "ｓ": return new Char(name, ["s"]);
        case "t": case "ｔ": return new Char(name, ["t"]);
        case "u": case "ｕ": return new Char(name, ["u"]);
        case "v": case "ｖ": return new Char(name, ["v"]);
        case "w": case "ｗ": return new Char(name, ["w"]);
        case "x": case "ｘ": return new Char(name, ["x"]);
        case "y": case "ｙ": return new Char(name, ["y"]);
        case "z": case "ｚ": return new Char(name, ["z"]);
